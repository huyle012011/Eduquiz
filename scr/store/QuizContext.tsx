...
export const QuizProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // BUG FIX: Supabase Realtime filter compares as text; user.id is a UUID string —
    // this works, but only for logged-in users. Guest attempts (user_id = 'guest-xxx')
    // will never match a UUID, so guests correctly receive no realtime updates.
